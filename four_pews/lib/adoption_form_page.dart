...
import 'package:four_pews/utils/submit_dialog.dart';

class AdoptionFormPage extends StatefulWidget {
  final ProductModel model;
  const AdoptionFormPage({super.key, required this.model});
...
class _AdoptionFormPageState extends State<AdoptionFormPage> {
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    getDescTextFiledWidget(
                        context, "Enter Address..", textDescController),
                    SizedBox(
                      height: (margin),
                    ),
                    getTextWithFontFamilyWidget(
                    ...
                    getTextWithFontFamilyWidget(
                        ...
                        TextAlign.start),
                    getDescTextFiledWidget(
                        context, "Describe your Reason..", textDescController),
                    SizedBox(
                      height: (margin),
                    ),
                  ],
  ...
  getTextFiledShapeDecoration({Color? color}) {
    return ShapeDecoration(
      ...
      shape: SmoothRectangleBorder(
        side:
            BorderSide(color: (color == null) ? borderColor : color, width: 1),
        borderRadius: SmoothBorderRadius(
          cornerRadius: radius,
          cornerSmoothing: 0.8,
        ),
  ...
  Widget getRadioButton(BuildContext context, String s, int position) {
    return InkWell(
      ...
      child: Container(
        ...
        margin: EdgeInsets.only(bottom: getScreenPercentSize(context, 1.2)),
        // padding:
        //     EdgeInsets.symmetric(horizontal: getWidthPercentSize(context, 2)),
        alignment: Alignment.centerLeft,
        // decoration: getShapeDecoration(),
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  color: (radioPosition == position)
                      ? primaryColor
                      : Colors.transparent,
                  borderRadius: BorderRadius.all(
                      Radius.circular(getPercentSize(cellHeight, 12)))),
              child: Center(
                child: Icon(
                  Icons.check,
            ...
            getCustomTextWidget(
                s, textColor, fontSize, FontWeight.w400, TextAlign.start, 1)
          ],
        ),
      ),
    );
